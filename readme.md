...
// На самом деле мне еще предстоит проверить корректность работы нескольких инстансов сразу, пока я проверял только потерю лидерства и
// повторный захват тем же инстансом, и имитацию захвата другим. Но полноценная проверка будет в рамках уже LAN based tests.
